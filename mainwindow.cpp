...
MainWindow::MainWindow(QWidget *parent) : QWidget(parent), ui(new Ui::MainWindow) {
    ...
    insert_buttons[0] = new QPushButton("Insert data into the table \"Bank\"", this);
    insert_buttons[1] = new QPushButton("Insert data into the table \"Account\"", this);
    insert_buttons[2] = new QPushButton("Insert data into the table \"Currency\"", this);
    insert_buttons[3] = new QPushButton("Insert data into the table \"StockMarket\"", this);
    insert_buttons[4] = new QPushButton("Insert data into the table \"Transaction\"", this);
