/****************************************************************************
** Meta object code from reading C++ file 'transaction.hpp'
**
...
#error "The header file 'transaction.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(5, 78, 36) // "onButtonClickedTransactionSta..."

    },
    "Transaction\0onButtonClickedDeleted\0\0"
    "onButtonClickedDeletedOne\0onButtonClicked\0"
    "onButtonClickedTransactionStatistics"
};
...
void Transaction::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->onButtonClickedTransactionStatistics(); break;
        default: ;
        }
    }
    (void)_a;
